/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 194140900f51b13e7f226d0adb33211c)
// Runtime types generated with workerd@1.20251011.0 2025-10-11 
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "SubscriptionPool" | "TrendingRollup";
	}
	interface Env {
		KV: KVNamespace;
		OPENTRIPMAP_API_KEY: "";
		ORS_API_KEY: "";
		GRAPHQL_URL: string;
		SUBSCRIPTION_POOL: DurableObjectNamespace<import("./worker/index").SubscriptionPool>;
		TRENDING_ROLLUP: DurableObjectNamespace<import("./worker/index").TrendingRollup>;
		R2: R2Bucket;
		DB: D1Database;
		EMBED_QUEUE: Queue;
		VECTORIZE: VectorizeIndex;
		AI: Ai;
		TRIP_CREATION_WORKFLOW: Workflow<Parameters<import("./worker/index").TripCreationWorkflow['run']>[0]['payload']>;
		TRIP_UPDATE_WORKFLOW: Workflow<Parameters<import("./worker/index").TripUpdateWorkflow['run']>[0]['payload']>;
	}
}
