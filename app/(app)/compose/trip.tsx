...
export default function CreateTripScreen() {
  ...
  const _isHosted = params.isHosted === 'true'; // TODO: Use when GraphQL schema supports isHosted in Phase 9
      ...
      const res = await createTrip({
        variables: {
          input: {
            ...
            // TODO: Add isHosted to CreateTripInput in GraphQL schema (Phase 9-10)
            // isHosted: isHosted || undefined,
          },
        },
